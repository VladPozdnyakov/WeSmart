...
const AboutUsSlider = () => {
  ...
  const contentData = [
    ...
    },
    {
      text: (
        <>
          ...
          <br/>
          FEWER FALSE ALERTS WESMART PROVIDED<br/>
          INNOVATIVE SOLUTIONS AND RAPID DEVELOPMENTS,<br/>
          DELIVERED OUTSTANDING PERFORMANCE IN THE FIELD<br/>
          OF PEOPLE COUNTING IN CROWDED AREAS,<br/>
    ...
    },
    {
      text: (
        <>
          WORKING WITH THE WESMART TEAM LED BY OR WAS<br/>
          A SMOOTH, ENJOYABLE, AND PRODUCTIVE PROCESS.<br/>
          OR IS A PROFESSIONAL WITH EXTENSIVE EXPERIENCE<br/>
          IN THE FIELD OF SECURITY, WHO HAS IMPROVED THE<br/>
          SECURITY OF THE SETTLEMENT. THE AVAILABILITY WAS<br/>
          AROUND THE CLOCK, AND THEIR SYSTEM SOLVED<br/>
